...
public class ProveedorController {
	...
	public ResponseEntity<List<Proveedores>> getAllProveedres(@RequestParam(required = false) String nit){
		try{
			...
			if (nit == null)
				...
				proveedorRepo.findByNit(nit).forEach(proveedor::add);
	...
	public ResponseEntity<Proveedores> createProveedor(@RequestBody Proveedores proveedor){
		try {
			Proveedores _proveedor= proveedorRepo.save(new Proveedores(proveedor.getNit(), proveedor.getCiudad_proveedor(), proveedor.getDireecion_proveedor(), proveedor.getNombre_proveedor(), proveedor.getTelefono_proveedor()));
