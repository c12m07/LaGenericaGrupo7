...
public class ProductoController {
	...
	@GetMapping("/productos")
	  ...
	  public ResponseEntity<Producto> createProducto(@RequestBody Producto producto) {
		  try {
			    Producto _producto = productoRepo.save(new Producto(producto.getCodigo(), producto.getNombre_producto(), producto.getNitproveedor(), producto.getPrecio_compra(), producto.getIvacompra(), producto.getPrecio_venta()));
